...
const socialLinks = [
  {
    ...
    subText: "@yudstir4",
    icon: Instagram,
    url: "https://www.instagram.com/yudstir4/?igsh=MXhieTFoZzNuZXNiMQ%3D%3D",
    color: "#E4405F",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@yudistiramalik",
    icon: Github,
    url: "https://github.com/yudistiramalik",
    color: "#ffffff",
...
const SocialLinks = () => {
  // Instagram di index 0, GitHub 1, TikTok 2
  const [instagram, github, tiktok] = socialLinks;
